...
function initPayment() {
  ...
  fetch(`${serverUrl}api/payment-intent`, {
    method: 'POST',
    headers: {
...
function saveOrderInDataBase() {
  //const usuario = document.querySelector('shoppingCartTotal').textContent;
  const usuario = "5fd0f3120d0c0748c42f83e8"; 
  ...
  fetch(`${serverUrl}api/pedido`, {
    ...
    .then((res) =>{
      ...
      for (i = 0; i < shoppingCartTotal.length; ++i) {
          shoppingCartTotal[i].innerHTML = '00.00$'; 
        }
